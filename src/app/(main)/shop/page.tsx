        ...
        <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 space-y-4">
                 ...
                 <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest">
                    <span className="text-muted-foreground">Price: <span className="text-foreground">RS 0 — RS 1000</span></span>
          ...
          <main className="flex-1 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-card border border-border p-3 px-6 rounded-2xl shadow-sm">
               <p className="text-muted-foreground text-[14px] font-medium uppercase tracking-widest font-subheading">Showing 1–{data?.products.length || 0} results</p>
               <div className="flex items-center gap-4">
                  ...
                  <div className="relative group">
                     <select className="bg-muted/30 border border-border text-foreground text-[14px] font-medium uppercase tracking-widest px-4 py-2 rounded-lg appearance-none pr-10 outline-none focus:border-primary transition-all font-subheading">

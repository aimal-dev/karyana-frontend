...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to login with the redirect parameter preserved
  ...
  return (
    <div className="mt-10 min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/20 p-4 pt-20 pb-20 relative overflow-hidden">
      <div className="absolute top-0 right-0 w-full h-full opacity-30 pointer-events-none">
         <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-primary/10 rounded-full blur-[150px] animate-pulse" />
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center pt-4">
            <p className="text-muted-foreground text-[10px] font-bold uppercase tracking-widest">
              ...
              <Link href="/login" className="text-primary ml-2 hover:underline font-black transition-colors">Sign In</Link>
            </p>
          </div>
        </form>
      </AuthCard>

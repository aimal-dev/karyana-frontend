    ...
    <div className="min-h-screen bg-background pt-20 pb-20">
      ...
      <div className="relative py-24 overflow-hidden border-b border-border bg-accent/20">
        <div className="container mx-auto px-4 lg:px-8 relative z-10 space-y-4 text-center">
           <p className="text-primary font-black tracking-[0.4em] uppercase text-[10px] font-subheading">Get In Touch</p>
           <h1 className="text-4xl md:text-6xl font-black tracking-tighter leading-none uppercase">CONNECT WITH <span className="text-primary italic">OUR CORE</span></h1>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 lg:px-8 py-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-32">
          ...
          <div className="group bg-card border border-border rounded-3xl p-10 space-y-6 hover:shadow-xl hover:border-primary/30 transition-all text-center">
             ...
             <div className="space-y-3">
                <h3 className="font-black text-lg uppercase tracking-tight font-subheading">Location</h3>
          ...
          <div className="group bg-card border border-border rounded-3xl p-10 space-y-6 hover:shadow-xl hover:border-primary/30 transition-all text-center">
             ...
             <div className="space-y-3">
                <h3 className="font-black text-lg uppercase tracking-tight font-subheading">Call Us</h3>
                <p className="text-muted-foreground font-medium text-xs leading-relaxed uppercase tracking-wider">
          ...
          <div className="group bg-card border border-border rounded-3xl p-10 space-y-6 hover:shadow-xl hover:border-primary/30 transition-all text-center">
             ...
             <div className="space-y-3">
                <h3 className="font-black text-lg uppercase tracking-tight font-subheading">Email</h3>
                <p className="text-muted-foreground font-medium text-xs leading-relaxed uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
           <div className="space-y-8">
              <div className="space-y-3">
                 <h2 className="text-primary font-black tracking-[0.3em] uppercase text-[10px] font-subheading">Send a Message</h2>
                 <h3 className="text-4xl font-black tracking-tighter leading-none uppercase">DO YOU HAVE ANY <span className="text-primary italic">QUESTIONS?</span></h3>
              </div>

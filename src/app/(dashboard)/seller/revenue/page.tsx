    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex items-end justify-between">
         <div>
            ...
            <p className="text-gray-400 font-medium uppercase tracking-[0.2em] text-[10px] mt-1 opacity-70">Track your sales performance and product revenue</p>
         </div>
         ...
         <div className="flex items-center gap-4 bg-white/5 p-1.5 rounded-2xl border border-white/5">
            {ranges.map(r => (
              <button
                ...
                className={cn(
                  "px-6 py-2.5 rounded-xl text-[10px] font-medium uppercase tracking-widest transition-all",
                  range === r.id 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         <div className="bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-[2rem] p-8 text-white shadow-2xl shadow-indigo-500/20">

      ...
      <div className="flex items-end justify-between">
         ...
         <div className="px-6 py-3 rounded-2xl bg-white/5 border border-white/5 flex items-center gap-6">
            <div className="flex flex-col items-end">
               <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Global Sentiment</span>
               <div className="flex items-center gap-2 mt-0.5">
                  <span className="text-xl font-black text-white">Positive</span>
      ...
      <div className="grid grid-cols-1 gap-12">
         {report?.length === 0 ? (
           <div className="bg-white/5 border border-dashed border-white/10 rounded-[3rem] p-24 text-center">
              ...
              <h3 className="text-2xl font-black text-white">No reviews yet</h3>
              <p className="text-gray-500 font-bold text-xs uppercase tracking-widest mt-2">Feedback will appear here once customers start rating products.</p>
           </div>
         ) : (
                   ...
                   <div className="flex items-center gap-4">
                      ...
                      <div>
                         ...
                         <div className="flex items-center gap-2 mt-1">
                            ...
                            <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest">{product.avgRating} / 5.0</span>
                            <span className="text-gray-800 font-bold">•</span>
                            <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">{product.totalReviews} total reviews</span>
                         </div>
                      </div>
                   </div>
                     ...
                     <div key={review.id} className="bg-white/5 border border-white/5 rounded-3xl p-6 hover:bg-white/[0.08] hover:border-white/10 transition-all duration-300 group flex flex-col h-full">
                        <div className="flex items-start justify-between mb-4">
                           <div className="flex items-center gap-3">
                              <div className="size-10 rounded-xl bg-white/5 flex items-center justify-center text-gray-400 font-black text-sm group-hover:bg-indigo-500 group-hover:text-white transition-all">
